...
export default function AdminFacilitators() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs Classification */}
      <div className="flex gap-2 border-b border-gray-200 pb-3 mb-2">
        <button
          onClick={() => {
            setActiveTab("attendance");
            setPage(1);
          }}
          className={`px-4 py-2 text-sm sm:text-base font-semibold rounded-t-xl transition-all duration-300 ${activeTab === "attendance" ? "bg-blue-600 text-white shadow-md transform -translate-y-1" : "bg-gray-100 text-gray-500 hover:bg-gray-200"}`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-sm sm:text-base font-semibold rounded-t-xl transition-all duration-300 ${activeTab === "education" ? "bg-emerald-600 text-white shadow-md transform -translate-y-1" : "bg-gray-100 text-gray-500 hover:bg-gray-200"}`}
        >
              ...
              <tbody>
                {paged.map((fac) => (
                  <tr key={fac._id?.toString()} className="hover:bg-gray-50">
                    ...
                    <td className="border p-3 text-responsive">
                      {fac.role === "Education Facilitator" ? (
                        <span className="text-gray-400 italic font-light text-sm">
                          Not Applicable
                        </span>
