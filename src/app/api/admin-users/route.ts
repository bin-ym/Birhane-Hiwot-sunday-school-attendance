...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    if (result.matchedCount === 0) {
      return NextResponse.json({ error: "Department admin not found" }, { status: 404 });
    }

    return NextResponse.json({ message: "Department admin updated" }, { status: 200 });
  } catch (error) {
    return NextResponse.json(
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ message: "Department admin deleted" }, { status: 200 });
  } catch (error) {
    return NextResponse.json(
