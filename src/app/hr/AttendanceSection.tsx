//src/app/hr/AttendanceSection.tsx
...
export default function AttendanceSection() {
  ...
  const isHRAdmin = session?.user?.role === "HR Admin";
  ...
  useEffect(() => {
    ...
    if (isHRAdmin || (facilitatorGrade && facilitatorGrade.length > 0)) {
      fetchData();
    } else {
      setStudents([]);
      setAttendance([]);
