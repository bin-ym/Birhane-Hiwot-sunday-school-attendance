// src/app/facilitator/attendance/students/page.tsx
"use client";
    ...
    <div className="min-h-screen flex flex-col gap-8 p-4">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link
            href="/facilitator/attendance/students/new"
                                    ...
                                    .map((student) => (
                                      ...
                                      >
                                        ...
                                        <td className="border p-3 flex gap-2">
                                          ...
                                          <Link
                                            href={`/facilitator/attendance/students/${student._id?.toString()}/edit`}
